...
class Home extends Component {
    ...
    applyBorder() {
        this.setState(state => ({showBorder1: !state.showBorder1}));
        this.setState(state => ({showBorder2: false}));
    }

    applyBorder2() {
        this.setState(state => ({showBorder2: !state.showBorder2}));
        this.setState(state => ({showBorder1: false}));
    }
        ...
        this.setState(
            {
                ...
                showBorder1: localStorage.get("showBorder1"),
